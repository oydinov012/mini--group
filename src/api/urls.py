...
from api.views.news_app import (
    NewsTypeListCreateView, NewsTypeDetailView,
    NewsListCreateView, NewsDetailView,
    NewsImageListCreateView, NewsImageDetailView,
)
...
urlpatterns = [
    ...
    path('products/<int:product_id>/images/', ProductImageListCreateView.as_view(), name='product_image_list'),
    ...
    path('news/types/', NewsTypeListCreateView.as_view(), name='news_type_list'),
    path('news/types/<int:pk>/', NewsTypeDetailView.as_view(), name='news_type_detail'),
    path('news/', NewsListCreateView.as_view(), name='news_list'),
    path('news/<int:pk>/', NewsDetailView.as_view(), name='news_detail'),
    path('news/<int:news_id>/images/', NewsImageListCreateView.as_view(), name='news_image_list'),
    path('news-images/<int:pk>/', NewsImageDetailView.as_view(), name='news_image_detail'),
]
